...
<div align="center">
<span style="text-align: center; overflow: hidden; align: center; display: inline-block; margin: 0.00px auto; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 283.66px; height: 261.50px;">![](images/image28.png)<img src="images/image28.png" align="middle"></span>
</div>
